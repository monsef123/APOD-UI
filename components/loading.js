...
class Loader extends HTMLElement {
  constructor() {
    ...
    this.loader = shadow.querySelector(".container");
  }
  ...
  attributeChangedCallback(name, _, newValue) {
    if (name === "data-loading" && newValue === "false") this.hideLoading();
    else if (name === "data-loading" && newValue === "true") this.showLoading();
  }
...
customElements.define("page-loader", Loader);
